...
/**
 * 
 * Class that modifies the Time and represent it on the GUI. To do this, it sets a new JLabel's Text every time it modifies a Time's instance. After that, it sleeps for 1s.
 * 
