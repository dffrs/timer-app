...
/**
 * Class responsible for creating a JSON file, saving the name of the project as well as the time spent working on it.
 * To do this, this class, first, creates an empty folder, where it will keep every saved .json file.
 * Then, it creates an instance of JSONObject, and writes it to a file.
 *
...
public final class JSONWriter {
     ...
     * @return Instance of JSONObject, that will be used to create the file itself. If it fails, for some reason,
     * it returns a NULL Reference.
     */
    private static JSONObject saveToJSONFormat(Map<String, List<String>> mapOfElements) {
    ...
    /**
     * Method responsible for creating an empty folder, that will be used to keep the .json file generated,
     * as well as the file itself. It uses {@link #makeDir()} method to create the Directory,
     * and {@link #saveToJSONFormat(Map)} method to generate a .json file.
     ...
     */
    public static void createJSONFile(String FileName, Map<String, List<String>> mapOfElement) {
        try {
            System.out.println("Creating a Directory.\n");
            makeDir();
            System.out.println("Directory created.\n");
        } catch (IOException e) {
            System.err.println("Warning: Something went wrong trying to create a storing folder." +
                " It already exists.\n");
        }
        ...
        if (json == null) {
            throw new NullPointerException("Error: Creating an instance of JSONObject." +
                " The argument was a NULL Reference.\n");
        } else {
